...
declare global {
     ...
     */
    var onPlayerMoveItemOutOfInventory: (
        playerId: PlayerId,
        itemName: string,
        itemAmount: number,
        fromIdx: number,
     ...
     */
    var onPlayerMoveInvenItemWithAmt: (
        playerId: PlayerId,
        i: number,
        j: number,
        amt: number,
     ...
     */
    var onPlayerDamagingOtherPlayer: (
     ...
     */
    var onPlayerDamagingMeshEntity: (
        playerId: PlayerId,
        damagedId: EntityId,
        damageDealt: number,
        withItem: string,
     ...
     */
    var onPlayerThrowableHitTerrain: (
        playerId: PlayerId,
        throwableName: ThrowableItem,
        thrownEntityId: EntityId,
    ) => void;
     ...
     */
    var onPlayerFinishChargingItem: (
        playerId: PlayerId,
        used: boolean,
        itemName: string,
        duration: number,
...
export type BlockbenchAnimationTimelineSchema =
...
export type BlockbenchBonesAnimationSchema = Readonly<
...
export type WorldBlockChangedCause =
...
export type NetworkedEntityType = LifeformType | ThrowableItem | string | string | "AudioEntity";
...
export type ItemNameWithEffects = {
    itemName: ItemName;
...
export type PlayerPhysicsState<TPhysicsType extends PhysicsType> = Readonly<{
    type: TPhysicsType;
...
export type MeshParticleSystemUpdates = Record<
    EntityId,
...
export type QueuedStatusString =
...
export interface _TypeOf {
    ...
    mobVariations: {
        ...
        readonly "Iron Guardian": readonly ["default"];
        readonly "Gold Guardian": readonly ["default"];
        readonly "Diamond Guardian": readonly ["default"];
        readonly "Moonstone Guardian": readonly ["default"];
